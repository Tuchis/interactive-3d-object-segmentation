...
class EvaluatorSO():
    ...
    def eval_results(self):
        ...
        for iou_max in self.MAX_IOU:
            ...
            for l in list(set(self.label_all)):    
                ...
                try:
                    ...
                    print(f"Error evaluating class {l}: {e}")
        ...
        results_dict = {
            ...
            'IoU@10': IOU_PER_CLICK_dict['10']/NOO_PER_CLICK_dict['10'] if IOU_PER_CLICK_dict is not None and NOO_PER_CLICK_dict is not None and '10' in NOO_PER_CLICK_dict and NOO_PER_CLICK_dict['10'] != 0 else 0,
            'IoU@15': IOU_PER_CLICK_dict['15']/NOO_PER_CLICK_dict['15'] if IOU_PER_CLICK_dict is not None and NOO_PER_CLICK_dict is not None and '15' in NOO_PER_CLICK_dict and NOO_PER_CLICK_dict['15'] != 0 else 0
        }
        print('****************************')
        print(results_dict)
